...
import { Plus, ArrowRight, Pencil, Settings, Trash2, GraduationCap, BookOpen, FolderOpen, HelpCircle } from 'lucide-react';
...
export default function PageGrupos() {
  ...
  return (
    <div className="min-h-screen">
      ...
      {manualAbierto && (
        <ModalManual onCerrar={() => setManualAbierto(false)} />
      )}
    </div>
  );
}
